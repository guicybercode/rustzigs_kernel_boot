...
const FONT_DATA: [u8; 256 * 16] = [
    ...
    0x00, 0x00, 0x66, 0x66, 0x66, 0x66, 0x66, 0x00, 0x00, 0x66, 0x66, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    0x00, 0x00, 0x7C, 0xC6, 0xC6, 0x0C, 0x18, 0x18, 0x18, 0x00, 0x00, 0x18, 0x18, 0x00, 0x00, 0x00,
    ...
    0x00, 0x00, 0xC3, 0xE7, 0xFF, 0xFF, 0xDB, 0xDB, 0xC3, 0xC3, 0xC3, 0xC3, 0x00, 0x00, 0x00, 0x00,
    ...
    0x00, 0x00, 0xC6, 0xC6, 0xC6, 0x6C, 0x6C, 0x38, 0x38, 0x38, 0x38, 0x7C, 0x00, 0x00, 0x00, 0x00,
...
pub fn draw_char(fb: &mut Framebuffer, x: u32, y: u32, ch: char, color: u32, bg_color: u32) {
    let ascii = ch as u8;
    let char_index = ascii as usize * FONT_HEIGHT as usize;
    
    for row in 0..FONT_HEIGHT {
        let font_byte = FONT_DATA[char_index + row as usize];
        
        for col in 0..FONT_WIDTH {
            let pixel_color = if (font_byte >> (7 - col)) & 1 != 0 {
                color
            } else {
                bg_color
            };
            
            fb.draw_pixel(x + col, y + row, pixel_color);
        }
    }
}
